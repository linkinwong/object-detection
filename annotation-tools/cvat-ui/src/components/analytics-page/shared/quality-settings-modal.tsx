...
export default function QualitySettingsModal(props: Props): JSX.Element | null {
    ...
    return (
        <Modal
            ...
            title={(
                <Text strong>
                    {t('analytics-page_shared_quality-settings-modal_tsx.AnnotationQualitySet', 'Annotation Quality Settings')}
                </Text>
            )}
            visible={visible}
            onOk={onOk}
        ...
        >
            { settings ? (
                ...
                <Text>
                    {t('analytics-page_shared_quality-settings-modal_tsx.Noqualitysettings', 'No quality settings')}
                </Text>
            )}
        </Modal>
    );
