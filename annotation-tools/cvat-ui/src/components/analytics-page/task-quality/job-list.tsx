...
function JobListComponent(props: Props): JSX.Element {
    ...
    const columns = [
        {
            title: t('analytics-page_task-quality_job-list_tsx.Jobs', 'Job'),
            dataIndex: 'job',
            key: 'job',
            sorter: sorter('key'),
            render: (id: number): JSX.Element => (
                <div>
                    ...
                    >
                        {t('analytics-page_task-quality_job-list_tsx.Jobs', 'Job')}
                        {` #${id}`}
                    </Button>
                </div>
            ),
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.Stage', 'Stage'),
            dataIndex: 'stage',
            key: 'stage',
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.Assignee', 'Assignee'),
            dataIndex: 'assignee',
            key: 'assignee',
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.FrameIntersection', 'Frame intersection'),
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.Conflicts', 'Conflicts'),
            dataIndex: 'conflicts',
            key: 'conflicts',
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.Quality', 'Quality'),
            dataIndex: 'quality',
            key: 'quality',
        ...
        {
            title: t('analytics-page_task-quality_job-list_tsx.Download', 'Download'),
            dataIndex: 'download',
            key: 'download',
