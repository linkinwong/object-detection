                                        ...
                                        (!(gtJob && gtJob.stage === 'acceptance' && gtJob.state === 'completed')) ? (
                                            <Row>
                                                <Text type='secondary' className='cvat-task-quality-reports-hint'>
                                                    {t('analytics-page_task-quality_task-quality-component_tsx.Qualityreportsarenot', 'Quality reports are not computed unless the GT job is in the')}
                                                    &nbsp;
                                                    <strong>
                                                        {t('analytics-page_task-quality_task-quality-component_tsx.completedstate', 'completed state')}
                                                    </strong>
                                                    &nbsp;
                                                    {t('analytics-page_task-quality_task-quality-component_tsx.and', 'and')}
                                                    &nbsp;
                                                    <strong>
                                                        {t('analytics-page_task-quality_task-quality-component_tsx.acceptancestage', 'acceptance stage.')}
                                                    </strong>
                                                </Text>
                                            </Row>
                                        ) : null
