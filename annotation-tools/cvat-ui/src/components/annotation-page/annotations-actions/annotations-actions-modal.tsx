        ...
        >
            <Row>
                <Col span={24} className='cvat-action-runner-info'>
                    <Alert
                        message={(
                            <div>
                                <Text>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Actionsallowexecutin', 'Actions allow executing certain algorithms on')}
                                </Text>
                                <Text strong>
                                    <a
                                        target='_blank'
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.filtered', 'filtered')}
                                    </a>
                                </Text>
                                <Text>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.annotations', 'annotations.')}
                                </Text>
                                <Text strong>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Itaffectsonlytheloca', 'It affects only the local browser state.')}
                                </Text>
                                <Text>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Onceanactionhasfinis', 'Once an action has finished,')}
                                </Text>
                                <Text strong>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.itcannotbereverted', 'it cannot be reverted.')}
                                </Text>
                                <Text>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Youmayreloadthepaget', 'You may reload the page to get annotations from the server.')}
                                </Text>
                                <Text strong>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Itisstronglyrecommen', 'It is strongly recommended to review the changes')}
                                </Text>
                                <Text strong>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.beforesavingannotati', 'before saving annotations to the server.')}
                                </Text>
                            </div>
                        )}
                        type='info'
                    ...
                    <Col span={24} className='cvat-action-runner-info'>
                        <Alert
                            message={(
                                <>
                                    <Text strong>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Recommendation', 'Recommendation: ')}
                                    </Text>
                                    <Button
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Clicktosavethejob', 'Click to save the job')}
                                    </Button>
                                </>
                            )}
                            type='warning'
                    ...
                    <Col span={24} className='cvat-action-runner-info'>
                        <Alert
                            message={(
                                <>
                                    <Text strong>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Recommendation_1', 'Recommendation:')}
                                    </Text>
                                    <Button
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Clicktodisableautoma', 'Click to disable automatic saving')}
                                    </Button>
                                </>
                            )}
                            type='warning'
                    ...
                    <Row>
                        <Col span={24}>
                            <Text strong className='cvat-text-color'>
                                {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.1Selectaction', '1. Select action')}
                            </Text>
                            <hr />
                        </Col>
                        <Col span={24}>
                    ...
                    <>
                        <Col span={24} className='cvat-action-runner-frames'>
                            <Row>
                                <Col span={24}>
                                    <Text strong>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.2Specifyframestoappl', '2. Specify frames to apply the action')}
                                    </Text>
                                    <hr />
                                </Col>
                                <Col span={24}>
                                    <Text>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Startingfromframe', 'Starting from frame')}
                                    </Text>
                                    <InputNumber
                                        value={frameFrom}
                                    ...
                                    />
                                    <Text>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.uptoframe', 'up to frame')}
                                    </Text>
                                    <InputNumber
                                        value={frameTo}
                                        min={frameFrom}
                        ...
                        <Col span={24} className='cvat-action-runner-frames-predefined'>
                            <Row>
                                <Col span={24}>
                                    <Text strong>
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Orchooseoneofpredefi', 'Or choose one of predefined options')}
                                    </Text>
                                    <hr />
                                </Col>
                                <Col span={24}>
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Currentframe', 'Current frame')}
                                    </Button>
                                    <Button
                                        onClick={() => {
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Allframes', 'All frames')}
                                    </Button>
                                    <Button
                                        onClick={() => {
                                            const current = storage.getState().annotation.player.frame.number;
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Fromcurrent', 'From current')}
                                    </Button>
                                    <Button
                                        onClick={() => {
                                            const current = storage.getState().annotation.player.frame.number;
                                    ...
                                    >
                                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Uptocurrent', 'Up to current')}
                                    </Button>
                                </Col>
                            </Row>
                        </Col>
                ...
                {activeAction?.parameters ? (
                    <Col span={24} className='cvat-action-runner-action-parameters'>
                        <Row>
                            <Col span={24}>
                                <Text strong>
                                    {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.3Setupactionparamete', '3. Setup action parameters')}
                                </Text>
                                <hr />
                            </Col>
                ...
                <Col span={24} className='cvat-action-runner-buttons'>
                    ...
                    >
                        {t('annotation-page_annotations-actions_annotations-actions-modal_tsx.Run', 'Run')}
                    </Button>
                </Col>
            </Row>
        </Modal>
