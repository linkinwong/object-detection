...
function AttributeAnnotationSidebar(props: StateToProps & DispatchToProps): JSX.Element {
            ...
            <Layout.Sider {...siderProps}>
                ...
                {activeAttribute ? (
                    ...
                    <div className='attribute-annotations-sidebar-not-found-wrapper'>
                        <Text strong>
                            {t('annotation-page_attribute-annotation-workspace_attribute-annotation-sidebar_attribute-annotation-sidebar_tsx.Noattributesfound', 'No attributes found')}
                        </Text>
                    </div>
                )}
    ...
    return (
        <Layout.Sider {...siderProps}>
            ...
            <div className='attribute-annotations-sidebar-not-found-wrapper'>
                <Text strong>
                    {t('annotation-page_attribute-annotation-workspace_attribute-annotation-sidebar_attribute-annotation-sidebar_tsx.Noobjectsfound', 'No objects found')}
                </Text>
            </div>
        </Layout.Sider>
    );
