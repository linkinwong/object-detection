...
function renderInputElement(parameters: InputElementParameters): JSX.Element {
    ...
    const renderCheckbox = (): JSX.Element => (
        <>
            <Text strong>
                {t('annotation-page_attribute-annotation-workspace_attribute-annotation-sidebar_attribute-editor_tsx.Checkbox', 'Checkbox:')}
            </Text>
    ...
    const renderSelect = (): JSX.Element => (
        <>
            <Text strong>
                {t('annotation-page_attribute-annotation-workspace_attribute-annotation-sidebar_attribute-editor_tsx.Values', 'Values:')}
            </Text>
            <div className='attribute-annotation-sidebar-attr-elem-wrapper'>
                <Select
    ...
    const renderRadio = (): JSX.Element => (
        <>
            <Text strong>
                {t('annotation-page_attribute-annotation-workspace_attribute-annotation-sidebar_attribute-editor_tsx.Values_1', 'Values:')}
            </Text>
            <div className='attribute-annotation-sidebar-attr-elem-wrapper'>
                <Radio.Group
                    value={localAttrValue}
