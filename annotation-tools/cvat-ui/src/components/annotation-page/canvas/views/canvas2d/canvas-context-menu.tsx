    ...
    return (
        <Menu onClick={onClick} selectable={false} className='cvat-canvas-context-menu' style={{ top, left }}>
            <Menu.Item className='cvat-context-menu-item' key={ReviewContextMenuKeys.OPEN_ISSUE}>
                {t('annotation-page_canvas_views_canvas2d_canvas-context-menu_tsx.Openanissue', 'Open an issue ...')}
            </Menu.Item>
            {conflict ? (
                <Menu.Item
            ...
            <Menu.Item className='cvat-context-menu-item' key={ReviewContextMenuKeys.QUICK_ISSUE_POSITION}>
                {t('annotation-page_canvas_views_canvas2d_canvas-context-menu_tsx.Quickissueincorrectp', 'Quick issue: incorrect position')}
            </Menu.Item>
            <Menu.Item className='cvat-context-menu-item' key={ReviewContextMenuKeys.QUICK_ISSUE_ATTRIBUTE}>
                {t('annotation-page_canvas_views_canvas2d_canvas-context-menu_tsx.Quickissueincorrecta', 'Quick issue: incorrect attribute')}
            </Menu.Item>
            ...
            {copyObject ? (
                ...
                >
                    {t('annotation-page_canvas_views_canvas2d_canvas-context-menu_tsx.Copyannotation', 'Copy annotation')}
                </Menu.Item>
            ) : null}
        </Menu>
    );
