            ...
            <div className='cvat-canvas-point-context-menu' style={{ top, left }}>
                ...
                (
                    <CVATTooltip title='Delete point [Alt + dblclick]'>
                        ...
                        >
                            {t('annotation-page_canvas_views_canvas2d_canvas-point-context-menu_tsx.Deletepoint', 'Delete point')}
                        </Button>
                    </CVATTooltip>
                )}
                ...
                {contextMenuFor && contextMenuFor.shapeType === 'polygon' && (
                    ...
                    >
                        {t('annotation-page_canvas_views_canvas2d_canvas-point-context-menu_tsx.Setstartpoint', 'Set start point')}
                    </Button>
                )}
            </div>,
