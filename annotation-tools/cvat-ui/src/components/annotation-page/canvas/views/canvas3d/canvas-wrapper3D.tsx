    ...
    (): JSX.Element => {
        ...
        return (
            <div className='cvat-canvas3d-orthographic-view cvat-canvas3d-topview'>
                { !canvasIsReady && <Spinner /> }
                <div className='cvat-canvas3d-header'>{t('annotation-page_canvas_views_canvas3d_canvas-wrapper3D_tsx.Top', 'Top')}</div>
                <div
    ...
    (): JSX.Element => {
        ...
        return (
            <div className='cvat-canvas3d-orthographic-view cvat-canvas3d-sideview'>
                { !canvasIsReady && <Spinner /> }
                <div className='cvat-canvas3d-header'>{t('annotation-page_canvas_views_canvas3d_canvas-wrapper3D_tsx.Side', 'Side')}</div>
                <div
                    className='cvat-canvas3d-fullsize'
                    ref={ref}
                />
    ...
    (): JSX.Element => {
        ...
        return (
            <div className='cvat-canvas3d-orthographic-view cvat-canvas3d-frontview'>
                { !canvasIsReady && <Spinner /> }
                <div className='cvat-canvas3d-header'>{t('annotation-page_canvas_views_canvas3d_canvas-wrapper3D_tsx.Front', 'Front')}</div>
                <div
                    className='cvat-canvas3d-fullsize'
                    ref={ref}
                />
