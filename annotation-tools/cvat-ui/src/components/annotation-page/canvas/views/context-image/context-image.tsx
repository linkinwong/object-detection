...
function ContextImage(props: Props): JSX.Element {
    ...
    return (
        <div className='cvat-context-image-wrapper'>
            ...
            { (hasError ||
                (!fetching && contextImageOffset >= Object.keys(contextImageData).length)) && <Text> {t('annotation-page_canvas_views_context-image_context-image_tsx.Nodata', 'No data')} </Text>}
