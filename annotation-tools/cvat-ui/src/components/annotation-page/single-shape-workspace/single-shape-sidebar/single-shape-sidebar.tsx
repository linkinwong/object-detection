        ...
        return (
            <Layout.Sider {...siderProps}>
                <div className='cvat-single-shape-annotation-sidebar-not-found-wrapper'>
                    <Text strong>
                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Noavailablelabelsfou', 'No available labels found')}
                    </Text>
                </div>
            </Layout.Sider>
        );
        ...
        <Layout.Sider {...siderProps}>
                    ...
                    <Col>
                        <Alert
                            ...
                            message={(
                                <>
                                    <Text>
                                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Annotate', 'Annotate')}
                                    </Text>
                                    <Text strong>{` ${(state.label as Label).name} `}</Text>
                                    <Text>
                                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.ontheimageusing', 'on the image, using')}
                                    </Text>
                        ...
                        <Row justify='start' className='cvat-single-shape-annotation-sidebar-skip-wrapper'>
                            <Col>
                                ...
                                >
                                    {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Skip', 'Skip')}
                                </Button>
                            </Col>
                        </Row>
                        <Alert
                            ...
                            message={(
                                <ul>
                                    <li>
                                        <Text>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Click', 'Click')}
                                        </Text>
                                        <Text strong>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Skip_1', ' Skip ')}
                                        </Text>
                                        <Text>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.ifthereisnothingtoan', 'if there is nothing to annotate')}
                                        </Text>
                                    </li>
                                    <li>
                                        <Text>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Hold', 'Hold')}
                                        </Text>
                                        <Text strong>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Alt', ' [Alt] ')}
                                        </Text>
                                        <Text>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.buttontoavoiddrawing', 'button to avoid drawing on click')}
                                        </Text>
                                    </li>
                                    <li>
                                        <Text>Press</Text>
                                        ...
                                        <Text>
                                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.toundoacreatedobject', 'to undo a created object')}
                                        </Text>
                                    </li>
                                    { (!isPolylabel || !state.pointsCountIsPredefined || state.pointsCount > 1) && (
                                        <li>
                                            ...
                                            <Text>
                                                {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.toresetdrawingproces', 'to reset drawing process')}
                                            </Text>
                                        </li>
                                    ) }
                                    ...
                                    { (isPolylabel && (!state.pointsCountIsPredefined || state.pointsCount > 1)) && (
                                        <li>
                                            ...
                                            <Text>
                                                {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.tofinishdrawingproce', 'to finish drawing process')}
                                            </Text>
                                        </li>
                                    ) }
                                </ul>
            ...
            { withLabelsSelector && (
                <>
                    <Row justify='start' className='cvat-single-shape-annotation-sidebar-label'>
                        <Col>
                            <Text strong>
                                {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Labelselector', 'Label selector')}
                            </Text>
                        </Col>
                    </Row>
            ...
            { withLabelTypeSelector && (
                <>
                    <Row justify='start' className='cvat-single-shape-annotation-sidebar-label-type'>
                        <Col>
                            <Text strong>
                                {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Labeltypeselector', 'Label type selector')}
                            </Text>
                        </Col>
                    </Row>
            ...
            <Row className='cvat-single-shape-annotation-sidebar-auto-next-frame-checkbox'>
                <Col>
                    ...
                    >
                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Automaticallygotothe', 'Automatically go to the next frame')}
                    </Checkbox>
                </Col>
            </Row>
            <Row className='cvat-single-shape-annotation-sidebar-auto-save-checkbox'>
                <Col>
                    ...
                    >
                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Automaticallysavewhe', 'Automatically save when finish')}
                    </Checkbox>
                </Col>
            </Row>
            <Row className='cvat-single-shape-annotation-sidebar-navigate-empty-checkbox'>
                <Col>
                    ...
                    >
                        {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Navigateonlyemptyfra', 'Navigate only empty frames')}
                    </Checkbox>
                </Col>
            </Row>
            { isPolylabel && (
                <Row className='cvat-single-shape-annotation-sidebar-predefined-pounts-count-checkbox'>
                    <Col>
                        ...
                        >
                            {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Predefinednumberofpo', 'Predefined number of points')}
                        </Checkbox>
                    </Col>
                </Row>
            )}
            { isPolylabel && state.pointsCountIsPredefined ? (
                <>
                    <Row justify='start' className='cvat-single-shape-annotation-sidebar-points-count'>
                        <Col>
                            <Text strong>
                                {t('annotation-page_single-shape-workspace_single-shape-sidebar_single-shape-sidebar_tsx.Numberofpoints', 'Number of points')}
                            </Text>
                        </Col>
                    </Row>
