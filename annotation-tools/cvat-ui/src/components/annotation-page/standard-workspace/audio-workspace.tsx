...
import JobAudioAnnotatorComponent from 'components/jobs-page/job-audio';

export default function AudioWorkspaceComponent(props): JSX.Element {
    return (
        <Layout hasSider className='cvat-standard-workspace'>
            <JobAudioAnnotatorComponent {...props} />
