...
function DrawShapePopoverComponent(props: Props): JSX.Element {
    ...
    return (
        <div className='cvat-draw-shape-popover-content'>
            ...
            <Row justify='start'>
                <Col>
                    <Text className='cvat-text-color'>{t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Label', 'Label')}</Text>
                </Col>
            </Row>
            <Row justify='center'>
                <Col span={24}>
            ...
            {is2D && shapeType === ShapeType.RECTANGLE && (
                <>
                    <Row>
                        <Col>
                            <Text className='cvat-text-color'> {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Drawingmethod', 'Drawing method')} </Text>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            ...
                            >
                                <Radio value={RectDrawingMethod.CLASSIC} style={{ width: 'auto' }}>
                                    {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.By2Points', 'By 2 Points')}
                                </Radio>
                                <Radio value={RectDrawingMethod.EXTREME_POINTS} style={{ width: 'auto' }}>
                                    {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.By4Points', 'By 4 Points')}
                                </Radio>
                            </Radio.Group>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            ...
                            >
                                <Radio value={CuboidDrawingMethod.CLASSIC} style={{ width: 'auto' }}>
                                    {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Fromrectangle', 'From rectangle')}
                                </Radio>
            ...
            {is2D && [ShapeType.POLYGON, ShapeType.POLYLINE, ShapeType.POINTS].includes(shapeType) ? (
                <Row justify='space-around' align='middle'>
                    <Col span={14}>
                        <Text className='cvat-text-color'> {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Numberofpoints', 'Number of points:')} </Text>
                    </Col>
                    <Col span={10}>
                        <InputNumber
            ...
            <Row justify='space-around'>
                <Col span={24}>
                    <CVATTooltip title={`Press ${repeatShapeShortcut} to draw again`}>
                        <Button className={`cvat-draw-${shapeType}-shape-button`} onClick={onDrawShape}>{t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Shape', 'Shape')}</Button>
                    </CVATTooltip>
                    {shapeType !== ShapeType.MASK && (
                        <CVATTooltip title={`Press ${repeatShapeShortcut} to draw again`}>
                            <Button
                                ...
                                onClick={onDrawTrack}
                            >
                                {t('annotation-page_standard-workspace_controls-side-bar_draw-shape-popover_tsx.Track', 'Track')}
                            </Button>
                        </CVATTooltip>
                    )}
                </Col>
