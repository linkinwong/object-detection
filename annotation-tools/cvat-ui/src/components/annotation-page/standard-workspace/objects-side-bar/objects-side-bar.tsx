    ...
    return (
        ...
        >
            ...
            <Tabs type='card' defaultActiveKey='objects' className='cvat-objects-sidebar-tabs'>
                <Tabs.TabPane tab={<Text strong>{t('annotation-page_standard-workspace_objects-side-bar_objects-side-bar_tsx.Objects', 'Objects')}</Text>} key='objects'>
                    {objectsList}
                </Tabs.TabPane>
                <Tabs.TabPane forceRender tab={<Text strong>{t('annotation-page_standard-workspace_objects-side-bar_objects-side-bar_tsx.Labels', 'Labels')}</Text>} key='labels'>
                    <LabelsList />
                </Tabs.TabPane>

                {is2D ? (
                    <Tabs.TabPane tab={<Text strong>{t('annotation-page_standard-workspace_objects-side-bar_objects-side-bar_tsx.Issues', 'Issues')}</Text>} key='issues'>
                        <IssuesListComponent />
                    </Tabs.TabPane>
                ) : null}
            </Tabs>
