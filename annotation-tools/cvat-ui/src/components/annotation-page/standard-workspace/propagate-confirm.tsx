...
function PropagateConfirmComponent(): JSX.Element {
    ...
    return (
        <Modal
            ...
            title={t('annotation-page_standard-workspace_propagate-confirm_tsx.ConfirmPropagation')}
            visible={visible}
            destroyOnClose
        ...
        >
            <div className='cvat-propagate-confirm'>
                <Row>
                    <Col>
                        <Text>
                            {t('annotation-page_standard-workspace_propagate-confirm_tsx.Pleasespecifyadirect', 'Please, specify a direction')}
                        </Text>
                    </Col>
                    <Col offset={1}>
                        <Radio.Group
                ...
                <Row>
                    <Col>
                        {t('annotation-page_standard-workspace_propagate-confirm_tsx.Howmanycopiesdoyouwa', 'How many copies do you want to create?')}
                    </Col>
                    <Col offset={1}>
                        <InputNumber
                ...
                <Row className='cvat-propagate-up-to-wrapper'>
                    <Col span={24}>
                        <Text>
                            {t('annotation-page_standard-workspace_propagate-confirm_tsx.Orspecifyarangewhere', 'Or specify a range where copies will be created ')}
                        </Text>
                    </Col>
