    ...
    return controlsDisabled ? (
        <Layout.Sider {...siderProps}>
            ...
            <Row justify='center' className='cvat-tag-annotation-sidebar-empty'>
                <Col>
                    <Text strong>
                        {t('annotation-page_tag-annotation-workspace_tag-annotation-sidebar_tag-annotation-sidebar_tsx.Cantplacetagonthisfr', 'Can&apos;t place tag on this frame.')}
                    </Text>
                </Col>
            </Row>
        </Layout.Sider>
            ...
            <Layout.Sider {...siderProps}>
                ...
                <Row className='cvat-tag-annotation-sidebar-checkbox-skip-frame'>
                    <Col>
                        ...
                        >
                            {t('annotation-page_tag-annotation-workspace_tag-annotation-sidebar_tag-annotation-sidebar_tsx.Automaticallygotothe', 'Automatically go to the next frame')}
                        </Checkbox>
                    </Col>
                </Row>
                <Row>
                ...
                <Row justify='center' className='cvat-tag-annotation-sidebar-shortcut-help'>
                    <Col>
                        <Text>
                            ...
                            &nbsp;or digits&nbsp;
                            <Text code>0-9</Text>
                            {t('annotation-page_tag-annotation-workspace_tag-annotation-sidebar_tag-annotation-sidebar_tsx.toaddselectedtagAdd', '&nbsp;to add selected tag.&nbsp;\n' +
                            'Add&nbsp;')}
                            <Text code>Shift</Text>
                            {t('annotation-page_tag-annotation-workspace_tag-annotation-sidebar_tag-annotation-sidebar_tsx.modifiertoremovesele', '&nbsp;modifier to remove selected tag.')}
                        </Text>
                    </Col>
                </Row>
            </Layout.Sider>
