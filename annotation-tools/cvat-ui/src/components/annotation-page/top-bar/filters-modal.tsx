    ...
    return (
        <Modal
            ...
            footer={[
                ...
                >
                    {t('annotation-page_top-bar_filters-modal_tsx.Clearfilters', 'Clear filters')}
                </Button>,
                <Button
                    key='cancel'
                ...
                >
                    {t('annotation-page_top-bar_filters-modal_tsx.Cancel', 'Cancel')}
                </Button>,
                <Button
                    key='submit'
                    type='primary'
                ...
                >
                    {t('annotation-page_top-bar_filters-modal_tsx.Submit', 'Submit')}
                </Button>,
            ]}
        >
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        {t('annotation-page_top-bar_filters-modal_tsx.Submit', 'Recently used')}
                        {' '}
                        <DownOutlined />
                    </Button>
                </Dropdown>
