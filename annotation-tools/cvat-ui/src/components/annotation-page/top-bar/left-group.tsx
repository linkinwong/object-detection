    ...
    return (
        <>
            ...
            <Modal className='cvat-saving-job-modal' title='Saving changes on the server' visible={saving} footer={[]} closable={false}>
                <Text>
                    {t('annotation-page_top-bar_left-group_tsx.CVATissavingyouranno', 'CVAT is saving your annotations, please wait')}
                </Text>
                <LoadingOutlined />
            </Modal>
            <Col className='cvat-annotation-header-left-group'>
                ...
                >
                    <Button type='link' className='cvat-annotation-header-menu-button cvat-annotation-header-button'>
                        ...
                        {t('annotation-page_top-bar_left-group_tsx.Menu', 'Menu')}
                    </Button>
                </Dropdown>
                <SaveButtonComponent
                    isSaving={saving}
                ...
                <CVATTooltip overlay={`Undo: ${undoAction} ${undoShortcut}`}>
                    ...
                    >
                        ...
                        <span>
                            {t('annotation-page_top-bar_left-group_tsx.Undo', 'Undo')}
                        </span>
                    </Button>
                </CVATTooltip>
                <CVATTooltip overlay={`Redo: ${redoAction} ${redoShortcut}`}>
                    ...
                    >
                        ...
                        {t('annotation-page_top-bar_left-group_tsx.Redo', 'Redo')}
                    </Button>
                </CVATTooltip>
                {includesDoneButton ? (
                    <CVATTooltip overlay={`Press "${drawShortcut}" to finish`}>
                        <Button type='link' className='cvat-annotation-header-done-button cvat-annotation-header-button' onClick={onFinishDraw}>
                            <CheckCircleOutlined />
                            {t('annotation-page_top-bar_left-group_tsx.Done', 'Done')}
                        </Button>
                    </CVATTooltip>
                ) : null}
                {includesToolsBlockerButton ? (
                    <CVATTooltip overlay={`Press "${switchToolsBlockerShortcut}" to postpone running the algorithm `}>
                        ...
                        >
                            <StopOutlined />
                            {t('annotation-page_top-bar_left-group_tsx.Block', 'Block')}
                        </Button>
                    </CVATTooltip>
                ) : null}
            </Col>
