    ...
    return (
        <Col className='cvat-annotation-header-right-group'>
            ...
            >
                ...
                {t('annotation-page_top-bar_right-group_tsx.Fullscreen', 'Fullscreen')}
            </Button>
            { jobInstance.guideId !== null && (
                ...
                >
                    ...
                    {t('annotation-page_top-bar_right-group_tsx.Guide', 'Guide')}
                </Button>
            )}
            <Button
                type='link'
            ...
            >
                ...
                {t('annotation-page_top-bar_right-group_tsx.Info', 'Info')}
            </Button>
            <Button
                type='link'
            ...
            >
                ...
                {t('annotation-page_top-bar_right-group_tsx.Filters', 'Filters')}
            </Button>
            {/*<div>
                <Select
