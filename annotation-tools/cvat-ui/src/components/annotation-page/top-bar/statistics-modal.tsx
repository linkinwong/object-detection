...
function StatisticsModalComponent(props: StateToProps & DispatchToProps): JSX.Element {
    ...
    const columns = [
        ...
        {
            title: <Text strong>{t('annotation-page_top-bar_statistics-modal_tsx.Manually', 'Manually')}</Text>,
            dataIndex: 'manually',
            key: 'manually',
            fixed: 'right',
            width: 100,
        ...
        {
            title: <Text strong>{t('annotation-page_top-bar_statistics-modal_tsx.Interpolated', 'Interpolated')}</Text>,
        ...
        {
            title: <Text strong>{t('annotation-page_top-bar_statistics-modal_tsx.Total', 'Total')}</Text>,
            dataIndex: 'total',
            key: 'total',
            fixed: 'right',
            width: 100,
    ...
    const columns3D = [
        ...
        {
            title: <Text strong>{t('annotation-page_top-bar_statistics-modal_tsx.Total_1', 'Total')}</Text>,
            dataIndex: 'total',
            key: 'total',
        },
    ];
    ...
    return (
        <Modal {...baseProps}>
            <div className='cvat-job-info-modal-window'>
                <Row justify='start'>
                    <Col>
                        <Text className='cvat-text'>{t('annotation-page_top-bar_statistics-modal_tsx.Overview', 'Overview')}</Text>
                    </Col>
                </Row>
                <Row justify='start'>
                    <Col span={4}>
                        <Text strong className='cvat-text'>
                            {t('annotation-page_top-bar_statistics-modal_tsx.Assignee', 'Assignee')}
                        </Text>
                        <Text className='cvat-text'>{assignee}</Text>
                    </Col>
                    <Col span={4}>
                        <Text strong className='cvat-text'>
                            {t('annotation-page_top-bar_statistics-modal_tsx.Startframe', 'Start frame')}
                        </Text>
                        <Text className='cvat-text'>{startFrame}</Text>
                    </Col>
                    <Col span={4}>
                        <Text strong className='cvat-text'>
                            {t('annotation-page_top-bar_statistics-modal_tsx.Stopframe', 'Stop frame')}
                        </Text>
                        <Text className='cvat-text'>{stopFrame}</Text>
                    </Col>
                    <Col span={4}>
                        <Text strong className='cvat-text'>
                            {t('annotation-page_top-bar_statistics-modal_tsx.Frames', 'Frames')}
                        </Text>
                ...
                {!!bugTracker && (
                    <Row justify='start' className='cvat-job-info-bug-tracker'>
                        <Col>
                            <Text strong className='cvat-text'>
                                {t('annotation-page_top-bar_statistics-modal_tsx.Bugtracker', 'Bug tracker')}
                            </Text>
                ...
                <Row justify='space-around' className='cvat-job-info-statistics'>
                    <Col span={24}>
                        <Text className='cvat-text'>{t('annotation-page_top-bar_statistics-modal_tsx.Annotationsstatistic', 'Annotations statistics')}</Text>
                        <Table
