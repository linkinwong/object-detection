        ...
        >
            <Meta
                ...
                description={(
                    <>
                        <Paragraph>
                            <Text type='secondary'>{t('cloud-storages-page_cloud-storage-item_tsx.Provider', 'Provider:')} </Text>
                            <Text>{providerType}</Text>
                        </Paragraph>
                        <Paragraph>
                            <Text type='secondary'>{t('cloud-storages-page_cloud-storage-item_tsx.Created', 'Created')} </Text>
                            {owner ? <Text type='secondary'>{`by ${owner.username}`}</Text> : null}
                            <Text type='secondary'> {t('cloud-storages-page_cloud-storage-item_tsx.on', 'on')} </Text>
                            <Text type='secondary'>{moment(createdDate).format('MMMM Do YYYY')}</Text>
                        </Paragraph>
                        <Paragraph>
                            <Text type='secondary'>{t('cloud-storages-page_cloud-storage-item_tsx.Lastupdated', 'Last updated')} </Text>
                        ...
                        <Dropdown
                            ...
                            overlay={(
                                <Menu className='cvat-project-actions-menu'>
                                    <Menu.Item onClick={onUpdate}>{t('cloud-storages-page_cloud-storage-item_tsx.Update', 'Update')}</Menu.Item>
                                    <Menu.Item onClick={onDelete}>{t('cloud-storages-page_cloud-storage-item_tsx.Delete', 'Delete')}</Menu.Item>
                                </Menu>
                            )}
                        >
                            <Button
