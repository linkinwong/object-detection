...
export default function CreateCloudStorageForm(props: Props): JSX.Element {
            ...
            return (
                <Form.Item
                    ...
                    label={(
                        ...
                        >
                            {t('create-cloud-storage-page_cloud-storage-form_tsx.Keyfile', 'Key file')}
                            <Button
                ...
                >
                    <Space align='start' className='cvat-cloud-storage-form-item-key-file'>
                        ...
                        >
                            <Space>
                                {t('create-cloud-storage-page_cloud-storage-form_tsx.Attachafile', 'Attach a file')}
                                <UploadOutlined />
                            </Space>
                        </Dragger>
                    </Space>
                ...
                >
                    <Select onSelect={(value: CredentialsType) => onChangeCredentialsType(value)}>
                        <Select.Option value={CredentialsType.KEY_SECRET_KEY_PAIR}>
                            {t('create-cloud-storage-page_cloud-storage-form_tsx.Keyidandsecretaccess', 'Key id and secret access key pair')}
                        </Select.Option>
                        <Select.Option value={CredentialsType.ANONYMOUS_ACCESS}>{t('create-cloud-storage-page_cloud-storage-form_tsx.Anonymousaccess', 'Anonymous access')}</Select.Option>
                    </Select>
                </Form.Item>
                {credentialsBlok()}
                <Form.Item
                ...
                >
                    <Select onSelect={(value: CredentialsType) => onChangeCredentialsType(value)}>
                        <Select.Option value={CredentialsType.ACCOUNT_NAME_TOKEN_PAIR}>
                            {t('create-cloud-storage-page_cloud-storage-form_tsx.AccountnameandSAStok', 'Account name and SAS token')}
                        </Select.Option>
                        <Select.Option value={CredentialsType.ANONYMOUS_ACCESS}>{t('create-cloud-storage-page_cloud-storage-form_tsx.Anonymousaccess', 'Anonymous access')}</Select.Option>
                        <Select.Option value={CredentialsType.CONNECTION_STRING}>{t('create-cloud-storage-page_cloud-storage-form_tsx.Connectionstring', 'Connection string')}</Select.Option>
                    </Select>
                </Form.Item>
    ...
    return (
        ...
        >
            <Form.Item
                {...commonProps}
                label={t('create-cloud-storage-page_cloud-storage-form_tsx.DisplayName', "Display name")}
                name='display_name'
                rules={[{ required: true, message: 'Please, specify a display name' }]}
            >
                <Input maxLength={63} />
            </Form.Item>
            <Form.Item {...commonProps} label={t('create-cloud-storage-page_cloud-storage-form_tsx.Description', "Description")} name='description'>
                <TextArea autoSize={{ minRows: 1, maxRows: 5 }} placeholder={t('create-cloud-storage-page_cloud-storage-form_tsx.AnyUsefulDescription', "Any useful description")} />
            </Form.Item>
            <Form.Item
                {...commonProps}
                label={t('create-cloud-storage-page_cloud-storage-form_tsx.Provider', "Provider")}
                name='provider_type'
            ...
            >
                ...
                >
                    ...
                    <Select.Option value={ProviderType.AZURE_CONTAINER}>
                        <span className='cvat-cloud-storage-select-provider'>
                            <AzureProvider />
                            {t('create-cloud-storage-page_cloud-storage-form_tsx.AzureBlobContainer', 'Azure Blob Container')}
                        </span>
                    </Select.Option>
                    <Select.Option value={ProviderType.GOOGLE_CLOUD_STORAGE}>
                        <span className='cvat-cloud-storage-select-provider'>
                            <GoogleCloudProvider />
                            {t('create-cloud-storage-page_cloud-storage-form_tsx.GoogleCloudStorage', 'Google Cloud Storage')}
                        </span>
                    </Select.Option>
                </Select>
            </Form.Item>
            ...
            <Form.Item
                label={(
                    <CVATTooltip title='Prefix is used to filter bucket content'>
                        {t('create-cloud-storage-page_cloud-storage-form_tsx.Prefix', 'Prefix')}
            ...
            <Row justify='end'>
                <Col>
                    <Button
                        ...
                        disabled={loading}
                    >
                        {t('create-cloud-storage-page_cloud-storage-form_tsx.Cancel', 'Cancel')}
                    </Button>
                </Col>
                <Col offset={1}>
                    <Button
                        ...
                        disabled={loading}
                    >
                        {cloudStorage ? t('create-cloud-storage-page_cloud-storage-form_tsx.Update', 'Update') : t('create-cloud-storage-page_cloud-storage-form_tsx.Submit', 'Submit')}
                    </Button>
                </Col>
            </Row>
        </Form>
