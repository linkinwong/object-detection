    ...
    return (
        <>
            <Form.Item
                ...
                label={(
                    <>
                        {t('create-cloud-storage-page_manifests-manager_tsx.Manifests', 'Manifests')}
                                ...
                                <Form.Item key={idx} shouldUpdate>
                                    <Row justify='space-between' align='top' className='cvat-cs-manifest-wrapper'>
                                        <Col>
                                            ...
                                            >
                                                <Input
                                                    placeholder={t('create-cloud-storage-page_manifests-manager_tsx.ManifestsJsonl', 'manifest.jsonl')}
            ...
            <Row justify='start'>
                <Col>
                    <Button type='ghost' onClick={onAddManifestItem} className='cvat-add-manifest-button'>
                        {t('create-cloud-storage-page_manifests-manager_tsx.Addmanifest', 'Add manifest')}
                        <PlusCircleOutlined />
                    </Button>
                </Col>
            </Row>
                ...
                <Row>
                    <Col span={24}>
                        <Alert
                            showIcon
                            type='info'
                            message={t('create-cloud-storage-page_manifests-manager_tsx.ManifestsAlertMsg', 'We highly recommend attaching a manifest file to reduce the number of requests to the bucket')}
                        />
                    </Col>
                </Row>
            )}
