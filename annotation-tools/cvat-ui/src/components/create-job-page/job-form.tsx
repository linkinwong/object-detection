...
function JobForm(props: Props): JSX.Element {
    ...
    return (
        <div className='w-full flex flex-col gap-4 p-4 bg-white'>
            <Form
                form={form}
                layout='vertical'
                initialValues={{
            ...
            >
                <Col>
                    <Form.Item
                        name='type'
                        label={t('create-job-page_job-form_tsx.JobType', 'Job type')}
                        rules={[{ required: true, message: t('create-job-page_job-form_tsx.JobTypeMessage', 'Please, specify Job type') }]}
                    >
                        <Select
                            virtual={false}
                        ...
                        >
                            <Select.Option value={JobType.GROUND_TRUTH}>
                                {t('create-job-page_job-form_tsx.Groundtruth', 'Ground truth')}
                            </Select.Option>
                        </Select>
                    </Form.Item>
                    <Form.Item
                        name='frame_selection_method'
                        label={t('create-job-page_job-form_tsx.FrameSelectionMethod', 'frame_selection_method')}
                        rules={[{ required: true, message: t('create-job-page_job-form_tsx.FrameSelectionMethodMessage', 'Please, specify frame selection method') }]}
                    >
                        <Select
                            virtual={false}
                        ...
                        >
                            <Select.Option value={FrameSelectionMethod.RANDOM}>
                                {t('create-job-page_job-form_tsx.Random', 'Random')}
                            </Select.Option>
                        </Select>
                    </Form.Item>
                </Col>
                    ...
                    <Row justify='space-between'>
                        <Col>
                            <Form.Item
                                ...
                                label={(
                                    <Space>
                                        {t('create-job-page_job-form_tsx.Quantity', 'Quantity %')}
                            ...
                            <Row>
                                <Col>
                                    <Form.Item
                                        ...
                                        label={(
                                            <Space>
                                                {t('create-job-page_job-form_tsx.Framecount', 'Frame count')}
                                                <CVATTooltip title={frameCountDescription}>
                                                    <QuestionCircleOutlined
                                                        style={{ opacity: 0.5 }}
                                                    />
                        ...
                        <Col>
                            <Form.Item
                                name='seed'
                                label={t('create-job-page_job-form_tsx.Seed', 'seed')}
                            >
                                <InputNumber
            ...
            <Button
                ...
                disabled={fetching}
            >
                {t('create-job-page_job-form_tsx.Submit', 'Submit')}
            </Button>
        </div>
    );
}
