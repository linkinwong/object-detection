    ...
    return (
        <Form layout='vertical' ref={formRef}>
            <Form.Item
                name='name'
                hasFeedback
                label={t('create-project-page_create-project-content_tsx.Name')}
                rules={[
                    {
                        required: true,
...
function AdvancedConfigurationForm(props: AdvancedConfigurationProps): JSX.Element {
    ...
    return (
        <Form layout='vertical' ref={formRef} initialValues={initialValues}>
            <Form.Item
                name='bug_tracker'
                label={t('create-project-page_create-project-content_tsx.label', 'Issue tracker')}
                extra={t('create-project-page_create-project-content_tsx.Specifysourcestorage', 'Attach issue tracker where the project is described')}
                hasFeedback
                rules={[
                    {
            ...
            <Row justify='space-between'>
                <Col span={11}>
                    <SourceStorageField
                        instanceId={null}
                        storageDescription={t('create-project-page_create-project-content_tsx.Specifysourcestorage_2', 'Specify source storage for import resources like annotation, backups')}
                ...
                <Col span={11} offset={1}>
                    <TargetStorageField
                        instanceId={null}
                        storageDescription={t('create-project-page_create-project-content_tsx.Specifysourcestorage_1', 'Specify target storage for export resources like annotation, backups')}
...
export default function CreateProjectContent(): JSX.Element {
    ...
    return (
        <Row justify='start' align='middle' className='cvat-create-project-content'>
            ...
            <Col span={24}>
                <Text className='cvat-text-color'>{t('create-project-page_create-project-content_tsx.Labels')}</Text>
                <LabelsEditor
            ...
            <Col span={24}>
                <Collapse className='cvat-advanced-configuration-wrapper'>
                    <Collapse.Panel key='1' header={<Text className='cvat-title'>{t('create-project-page_create-project-content_tsx.Advancedconfiguratio', 'Advanced configuration')}</Text>}>
                ...
                <Row justify='end' gutter={5}>
                    <Col>
                        <Button className='cvat-submit-open-project-button' type='primary' onClick={onSubmitAndOpen}>
                            {t('create-project-page_create-project-content_tsx.SubmitOpen', 'Submit & Open')}
                        </Button>
                    </Col>
                    <Col>
                        <Button className='cvat-submit-continue-project-button' type='primary' onClick={onSubmitAndContinue}>
                            {t('create-project-page_create-project-content_tsx.SubmitContinue', 'Submit & Continue')}
                        </Button>
                    </Col>
                </Row>
            </Col>
