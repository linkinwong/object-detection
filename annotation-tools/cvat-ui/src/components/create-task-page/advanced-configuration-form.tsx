...
class AdvancedConfigurationForm extends React.PureComponent<Props> {
    ...
    private renderCopyDataChechbox(): JSX.Element {
        return (
            ...
            >
                <Checkbox>
                    <Text className='cvat-text-color'>将数据复制</Text>
                </Checkbox>
            </Form.Item>
        );
    }
        ...
        return (
            ...
            >
                <Radio.Group buttonStyle='solid'>
                    ...
                    <Radio.Button value={SortingMethod.NATURAL} key={SortingMethod.NATURAL}>自然顺序</Radio.Button>
    ...
    private renderUzeZipChunks(): JSX.Element {
        return (
            <Space>
                ...
                <Text className='cvat-text-color'>偏好 ZIP 块</Text>
