                ...
                <div>
                    {percent === 100 ? (
                        <Row className='cvat-create-multi-tasks-state'>
                            <Col>
                                {t('create-task-page_multi-task-progress_tsx.Finished', 'Finished')}
                            </Col>
                        </Row>
                    ) : null}
                        ...
                        <Row>
                            ...
                            >
                                <Collapse.Panel
                                    header={(
                                        <Text strong>
                                            {t('create-task-page_multi-task-progress_tsx.Failedfiles', 'Failed files')}
                                        </Text>
                                    )}
                                    key='appearance'
                                >
                            ...
                            (
                                <>
                                    <Col>
                                        ...
                                        >
                                            {t('create-task-page_multi-task-progress_tsx.Retryfailedtasks', 'Retry failed tasks')}
                                        </Button>
                                    </Col>
                                    {
                                        countCancelled ? (
                                            <Col>
                                                ...
                                                >
                                                    {t('create-task-page_multi-task-progress_tsx.Retrycancelledtasks', 'Retry cancelled tasks')}
                                                </Button>
                                            </Col>
                                        ) : null
                                    }
                                    <Col>
                                        <Button
                                            ...
                                            onClick={onOk}
                                        >
                                            {t('create-task-page_multi-task-progress_tsx.Ok', 'Ok')}
                                        </Button>
                                    </Col>
                                </>
                            ) : (
                                <Col>
                                    ...
                                    >
                                        {t('create-task-page_multi-task-progress_tsx.Cancelpendingtasks', 'Cancel pending tasks')}
                                    </Button>
                                </Col>
                            )}
                    </Row>
