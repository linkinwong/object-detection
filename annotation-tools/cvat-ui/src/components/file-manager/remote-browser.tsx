        ...
        return (
            <>
                ...
                <Paragraph className='cvat-remote-browser-empty'>
                    {t('file-manager_remote-browser_tsx.Pleasebesureyouhad', 'Please, be sure you had')}
                    <Text strong>
                        <a href={SHARE_MOUNT_GUIDE_URL}> {t('file-manager_remote-browser_tsx.mounted', 'mounted')} </a>
                    </Text>
                    {t('file-manager_remote-browser_tsx.sharebeforeyoubuiltC', 'share before you built CVAT and the shared storage contains files')}
                </Paragraph>
            </>
        );
    }
                    ...
                    <Col className='cvat-remote-browser-incorrect-cs-prefix-wrapper' span={24}>
                        <Alert
                            ...
                            message={(
                                <>
                                    <Text>
                                        {t('file-manager_remote-browser_tsx.Thereisnointersectio', 'There is no intersection between the specified prefix and the default one')}
                                    </Text>
