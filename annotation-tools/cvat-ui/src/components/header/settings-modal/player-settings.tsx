...
export default function PlayerSettingsComponent(props: Props): JSX.Element {
    ...
    items.push([(
        <Row key='player-step' align='bottom' className='cvat-player-settings-step cvat-player-setting'>
            <Col>
                <Text className='cvat-text-color'> {t('header_settings-modal_player-settings_tsx.Playerstep', 'Player step')} </Text>
                <InputNumber
                    min={minFrameStep}
                    max={maxFrameStep}
                    value={frameStep}
            ...
            <Col offset={1}>
                <Text type='secondary'>
                    {t('header_settings-modal_player-settings_tsx.Numberofframesskippe', 'Number of frames skipped when selecting')}
                    <Icon component={BackJumpIcon} />
                    {t('header_settings-modal_player-settings_tsx.or', 'or')}
    ...
    items.push([(
        <Row key='player-speed' align='middle' className='cvat-player-settings-speed cvat-player-setting'>
            <Col>
                <Text className='cvat-text-color'> {t('header_settings-modal_player-settings_tsx.Playerspeed', 'Player speed')} </Text>
                <Select
                ...
                >
                    ...
                    >
                        {t('header_settings-modal_player-settings_tsx.Fastest', 'Fastest')}
                    </Select.Option>
                    <Select.Option key='fast' value={FrameSpeed.Fast} className='cvat-player-settings-speed-fast'>
                        {t('header_settings-modal_player-settings_tsx.Fast', 'Fast')}
                    </Select.Option>
                    <Select.Option
                        key='usual'
                    ...
                    >
                        {t('header_settings-modal_player-settings_tsx.Usual', 'Usual')}
                    </Select.Option>
                    <Select.Option key='slow' value={FrameSpeed.Slow} className='cvat-player-settings-speed-slow'>
                        {t('header_settings-modal_player-settings_tsx.Slow', 'Slow')}
                    </Select.Option>
                    <Select.Option
                        key='slower'
                    ...
                    >
                        {t('header_settings-modal_player-settings_tsx.Slower', 'Slower')}
                    </Select.Option>
                    <Select.Option
                        key='slowest'
                    ...
                    >
                        {t('header_settings-modal_player-settings_tsx.Slowest', 'Slowest')}
                    </Select.Option>
                </Select>
            </Col>
        </Row>
            ...
            <Col>
                ...
                >
                    <Button
                        ...
                        type='default'
                    >
                        {t('header_settings-modal_player-settings_tsx.Selectcanvasbackgrou', 'Select canvas background color')}
                    </Button>
                </Popover>
            </Col>
        </Row>
            ...
            <Col span={7}>
                <Row className='cvat-player-settings-reset-zoom'>
                    <Col span={24} className='cvat-player-settings-reset-zoom-checkbox'>
                        ...
                        >
                            {t('header_settings-modal_player-settings_tsx.Resetzoom', 'Reset zoom')}
                        </Checkbox>
                    </Col>
                    <Col span={24}>
                        <Text type='secondary'> {t('header_settings-modal_player-settings_tsx.Fitimageafterchangin', 'Fit image after changing frame')} </Text>
                    </Col>
                </Row>
            </Col>
            <Col span={7} offset={5}>
                <Row className='cvat-player-settings-rotate-all'>
                    <Col span={24} className='cvat-player-settings-rotate-all-checkbox'>
                        ...
                        >
                            {t('header_settings-modal_player-settings_tsx.Rotateallimages', 'Rotate all images')}
                        </Checkbox>
                    </Col>
                    <Col span={24}>
                        <Text type='secondary'> {t('header_settings-modal_player-settings_tsx.Rotateallimagessimul', 'Rotate all images simultaneously')} </Text>
                    </Col>
                </Row>
            </Col>
        </Row>
        ...
        <Row key='smooth-image' className='cvat-player-setting' justify='start'>
            <Col span={7}>
                <Row className='cvat-player-settings-smooth-image'>
                    <Col span={24} className='cvat-player-settings-smooth-image-checkbox'>
                        ...
                        >
                            {t('header_settings-modal_player-settings_tsx.Smoothimage', 'Smooth image')}
                        </Checkbox>
                    </Col>
                    <Col span={24}>
                        <Text type='secondary'> {t('header_settings-modal_player-settings_tsx.Smoothimagewhenzoomi', 'Smooth image when zoom-in it')} </Text>
                    </Col>
                </Row>
            </Col>
            <Col span={7} offset={5} className='cvat-workspace-settings-show-deleted'>
                <Row>
                    ...
                    >
                        {t('header_settings-modal_player-settings_tsx.Showdeletedframes', 'Show deleted frames')}
                    </Checkbox>
                </Row>
                <Row>
                    <Text type='secondary'>{t('header_settings-modal_player-settings_tsx.Youwillbeabletonavig', 'You will be able to navigate and restore deleted frames')}</Text>
                </Row>
            </Col>
        </Row>
    ), 40]);
