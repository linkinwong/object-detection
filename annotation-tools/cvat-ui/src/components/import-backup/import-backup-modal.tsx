...
function ImportBackupModal(): JSX.Element {
    ...
    const uploadLocalFile = (): JSX.Element => (
        ...
        >
            ...
            >
                ...
                <p className='ant-upload-text'>{t('import-backup_import-backup-modal_tsx.Clickordragfiletothi', 'Click or drag file to this area')}</p>
            </Upload.Dragger>
        </Form.Item>
    );
    ...
    const renderCustomName = (): JSX.Element => (
        <Form.Item
            label={<Text strong>{t('import-backup_import-backup-modal_tsx.Filename', 'File name')}</Text>}
            name='fileName'
    ...
    return (
        ...
        >
            ...
            >
                <SourceStorageField
                    instanceId={null}
                    storageDescription={t("import-backup_import-backup-modal_tsx.storageDescription")}
