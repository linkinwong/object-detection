...
function ImportDatasetModal(props: StateToProps): JSX.Element {
    ...
    const uploadLocalFile = (): JSX.Element => (
        ...
        >
            ...
            >
                ...
                <p className='ant-upload-text'>{t('import-dataset_import-dataset-modal_tsx.Clickordragfiletothi', 'Click or drag file to this area')}</p>
            </Upload.Dragger>
        </Form.Item>
    );
    ...
    const renderCustomName = (): JSX.Element => (
        <Form.Item
            label={<Text strong>{t('import-dataset_import-dataset-modal_tsx.Filename', 'File name')}</Text>}
            name='fileName'
            hasFeedback
            ...
            >
                ...
                >
                    ...
                    <Space className='cvat-modal-import-switch-conv-mask-to-poly-container'>
                        ...
                        <Text strong>{t('import-dataset_import-dataset-modal_tsx.Convertmaskstopolygo', 'Convert masks to polygons')}</Text>
                    ...
                    <Space className='cvat-modal-import-switch-use-default-storage-container'>
                        ...
                        <Text strong>{t('import-dataset_import-dataset-modal_tsx.Usedefaultsettings', 'Use default settings')}</Text>
