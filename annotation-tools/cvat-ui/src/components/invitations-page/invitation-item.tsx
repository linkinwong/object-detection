                ...
                <Card className={`cvat-invitation-item ${declined ? 'cvat-invitation-item-declined' : ''}`}>
                    <Row justify='space-between'>
                        ...
                        <Col className='cvat-invitation-actions'>
                            ...
                            >
                                {t('invitations-page_invitation-item_tsx.Accept', 'Accept')}
                            </Button>
                            {
                                expired ? (
                                    <Button
                                    ...
                                    >
                                        {t('invitations-page_invitation-item_tsx.Remove', 'Remove')}
                                    </Button>
                                ) : (
                                    <Button
                                        type='primary'
                                    ...
                                    >
                                        {t('invitations-page_invitation-item_tsx.Decline', 'Decline')}
                                    </Button>
                                )
                            }
                        </Col>
