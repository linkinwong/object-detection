...
class Renderer extends EventEmitter<RendererEvents> {
  ...
  private annotationsWrapper: HTMLElement
  private regionsWrapper: HTMLElement
  ...
  constructor(options: WaveSurferOptions, audioElement?: HTMLElement) {
    ...
    this.annotationsWrapper = shadow.querySelector('.annotations') as HTMLElement
    this.regionsWrapper = shadow.querySelector('.regionsWrapper') as HTMLElement
    ...
    shadow.innerHTML = `
      <style>
        ...
        :host .progress {
          ...
          position: absolute;
          z-index: 2;
          /* 20px is the height of timeline */
          top: 20px;
          left: 0;
          width: 0;
          height: 100%;
      ...
      <div class="scroll" part="scroll">
        <div class="wrapper" part="wrapper">
          ...
          <div class="regionsWrapper" part="regionsWrapper"></div>
          <div class="annotations" part="annotations"></div>
        </div>
      </div>
    `
  ...
  getRegionsWrapper(): HTMLElement {
    return this.regionsWrapper
  }
  ...
  renderRegions(labels: []) {
    ...
    for (const label of labels) {
      ...
      // div.style.width = '100%';
      // div.style.height = '100px'
      this.regionsWrapper.appendChild(label);
    }
  }
