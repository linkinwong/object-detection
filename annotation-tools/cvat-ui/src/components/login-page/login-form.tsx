...
function LoginFormComponent(props: Props): JSX.Element {
        ...
        <Col className='cvat-credentials-link'>
            <Text strong>
                <Link to={{ pathname: '/auth/password/reset', search: resetSearch }}>
                    {t('login-page_login-form_tsx.Forgotpassword', 'Forgot password?')}
                </Link>
            </Text>
        </Col>
    );
    ...
    return (
        <div className='cvat-login-form-wrapper'>
                ...
                }
                {
                    !credential && renderRegistrationComponent && (
                        <Row>
                            <Col className='cvat-credentials-link'>
                                <Text strong>
                                    {t('login-page_login-form_tsx.Newuser', 'New user?&nbsp;')}
                                    <Link to={{
                                        pathname: '/auth/register',
                                        search: authQuery ? new URLSearchParams(authQuery).toString() : '',
                                    }}
                                    >
                                        {t('login-page_login-form_tsx.Createanaccount', 'Create an account')}
                                    </Link>
                                </Text>
                            </Col>
                        </Row>
            ...
            <Col>
                <Title level={2}> {t('login-page_login-form_tsx.Signin', 'Sign in')} </Title>
            </Col>
            <Form
                    ...
                    <>
                        ...
                        >
                            <Input
                                ...
                                prefix={<Text>{t('login-page_login-form_tsx.Emailorusername', 'Email or username')}</Text>}
                            ...
                            credential && (
                                ...
                                >
                                    <CVATSigningInput
                                        ...
                                        id='password'
                                        placeholder={t('login-page_login-form_tsx.Password', 'Password')}
