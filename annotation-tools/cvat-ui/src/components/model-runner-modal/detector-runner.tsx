...
function DetectorRunner(props: Props): JSX.Element {
    ...
    return (
        <div className='cvat-run-model-content'>
            <Row align='middle'>
                <Col span={4}>{t('model-runner-modal_detector-runner_tsx.Model', 'Model:')}</Col>
                <Col span={20}>
                    <Select
            ...
            {convertMasks2PolygonVisible && (
                <div className='detector-runner-convert-masks-to-polygons-wrapper'>
                    ...
                    />
                    <Text>{t('model-runner-modal_detector-runner_tsx.Convertmaskstopolygo', 'Convert masks to polygons')}</Text>
                </div>
            )}
            {isDetector && withCleanup && (
                <div className='detector-runner-clean-previous-annotations-wrapper'>
                    ...
                    />
                    <Text>{t('model-runner-modal_detector-runner_tsx.Cleanpreviousannotat', 'Clean previous annotations')}</Text>
                </div>
            )}
            {isReId ? (
                <div>
                    <Row align='middle' justify='start'>
                        <Col>
                            <Text>{t('model-runner-modal_detector-runner_tsx.Threshold', 'Threshold')}</Text>
                        </Col>
                        <Col offset={1}>
                    ...
                    <Row align='middle' justify='start'>
                        <Col>
                            <Text>{t('model-runner-modal_detector-runner_tsx.Maximumdistance', 'Maximum distance')}</Text>
                        </Col>
                        <Col offset={1}>
            ...
            <Row align='middle' justify='end'>
                <Col>
                    ...
                    >
                        {t('model-runner-modal_detector-runner_tsx.Annotate', 'Annotate')}
                    </Button>
                </Col>
            </Row>
        </div>
