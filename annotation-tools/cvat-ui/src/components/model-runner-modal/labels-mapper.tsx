                ...
                if (modelLabel.type === ShapeType.SKELETON && taskLabel.type === ShapeType.SKELETON) {
                    extras.push(
                        <React.Fragment key='skeleton'>
                            <hr />
                            <Text strong>{t('model-runner-modal_labels-mapper_tsx.Skeletonpointsmappin', 'Skeleton points mapping:')} </Text>
                            <ObjectMatcher
                ...
                if (modelLabel.attributes?.length && taskLabel.attributes?.length) {
                    extras.push(
                        <React.Fragment key='attributes'>
                            <hr />
                            <Text strong>{t('model-runner-modal_labels-mapper_tsx.Labelattributesmappi', 'Label attributes mapping:')} </Text>
                            <ObjectMatcher
