...
export default function DeployedModelItem(props: Props): JSX.Element {
    ...
    const modelDescription = model.provider !== ModelProviders.CVAT ?
        ...
        <Text type='secondary'>{t('models-page_deployed-model-item_tsx.Systemmodel', 'System model')}</Text>;
            ...
            >
                ...
                <Divider />
                {
                    model.labels?.length ? (
                        <>
                            <div className='cvat-model-info-container'>
                                <Text className='cvat-model-info-modal-labels-title'>{t('models-page_deployed-model-item_tsx.Labels', 'Labels:')}</Text>
                            </div>
                ...
                <Row justify='space-between' className='cvat-model-info-container'>
                    <Col span={15}>
                        <Row>
                            <Col span={8}>
                                <Text strong>{t('models-page_deployed-model-item_tsx.Provider', 'Provider')}</Text>
                            </Col>
                            <Col>
                                <Text strong>{t('models-page_deployed-model-item_tsx.Type', 'Type')}</Text>
                            </Col>
                        </Row>
                        <Row>
                            <Col span={8}>
                    ...
                    {model.owner && (
                        <Col>
                            <Row>
                                <Col>
                                    <Text strong>{t('models-page_deployed-model-item_tsx.Owner', 'Owner')}</Text>
                                </Col>
                            </Row>
                            <Row>
                                <Col>
