...
function MoveTaskModal({
    ...
    return (
        ...
        >
            ...
            <Row align='middle'>
                <Col>{t('move-task-modal_move-task-modal_tsx.Project', 'Project:')}</Col>
                <Col>
                    <ProjectSearch
                        value={projectId}
            ...
            <Divider orientation='left'>{t('move-task-modal_move-task-modal_tsx.Labelmapping', 'Label mapping')}</Divider>
