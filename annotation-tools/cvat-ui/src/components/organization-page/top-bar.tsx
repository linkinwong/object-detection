        ...
        const modal = Modal.confirm({
            ...
            content: (
                <div className='cvat-remove-organization-submit'>
                    <Text type='warning'>
                        {t('organization-page_top-bar_tsx.Toremovetheorganizat', 'To remove the organization,\nenter its short name below')}
                    </Text>
                    <Input
                        onChange={
    ...
    return (
        <>
            <Row justify='space-between'>
                    ...
                    <div className='cvat-organization-top-bar-descriptions'>
                            ...
                            <Col>
                                    ...
                                    overlay={() => (
                                        <Menu className='cvat-organization-actions-menu'>
                                            <Menu.Item key={MenuActions.SET_WEBHOOKS}>
                                                ...
                                                >
                                                    {t('organization-page_top-bar_tsx.Setupwebhooks', 'Setup webhooks')}
                                                </a>
                                            </Menu.Item>
                                            {owner && userID === owner.id ? (
                                                <Menu.Item
                                                    ...
                                                    onClick={onRemove}
                                                >
                                                    {t('organization-page_top-bar_tsx.Removeorganization', 'Remove organization')}
                                                </Menu.Item>
                                            ) : null}
                                        </Menu>
                                    )}
                                >
                                    <Button size='middle' className='cvat-organization-page-actions-button'>
                                        <Text className='cvat-text-color'>{t('organization-page_top-bar_tsx.Actions', 'Actions')}</Text>
                        ...
                        {!editingDescription ? (
                            ...
                            <div ref={descriptionEditingRef}>
                                ...
                                >
                                    {t('organization-page_top-bar_tsx.Submit', 'Submit')}
                                </Button>
                            </div>
                        )}
                    </div>
                ...
                <Col span={12}>
                    <div className='cvat-organization-top-bar-contacts'>
                        <div>
                            <PhoneOutlined />
                            { !contact.phoneNumber ? <Text type='secondary'>{t('organization-page_top-bar_tsx.Addphonenumber', 'Add phone number')}</Text> : null }
                            <Text
                                type='secondary'
                                editable={{
                                    onChange: (value: string) => {
                        ...
                        <div>
                            <MailOutlined />
                            { !contact.email ? <Text type='secondary'>{t('organization-page_top-bar_tsx.Addemail', 'Add email')}</Text> : null }
                            <Text
                                type='secondary'
                                editable={{
                                    onChange: (value: string) => {
                        ...
                        <div>
                            <EnvironmentOutlined />
                            { !contact.location ? <Text type='secondary'>{t('organization-page_top-bar_tsx.Addlocation', 'Add location')}</Text> : null }
                            <Text
                                type='secondary'
                                editable={{
                                    onChange: (value: string) => {
                ...
                <Col span={12} className='cvat-organization-top-bar-buttons-block'>
                    <Space align='end'>
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    Modal.confirm({
                                        ...
                                        content: (
                                            <>
                                                <Text>{t('organization-page_top-bar_tsx.Pleaseconfirmleaving', 'Please, confirm leaving the organization')}</Text>
                                                <Text strong>{` ${organizationInstance.slug}`}</Text>
                                                <Text>{t('organization-page_top-bar_tsx.Youwillnothaveaccess', '. You will not have access to the organization data anymore')}</Text>
                                            </>
                                        ),
                                        okText: 'Leave',
                                        okButtonProps: {
                        ...
                        >
                            {t('organization-page_top-bar_tsx.Invitemembers', 'Invite members')}
                        </Button>
                    </Space>
                </Col>
            </Row>
            ...
            >
                ...
                >
                    <Paragraph>
                        <Text>{t('organization-page_top-bar_tsx.InviteCVATuserstocol', 'Invite CVAT users to collaborate ')}</Text>
                    </Paragraph>
                    <Paragraph>
                        <Text type='secondary'>
                            {t('organization-page_top-bar_tsx.Iftheemailaddressisr', 'If the email address is registered on CVAT, the user will be added to the organization')}
                        </Text>
                    </Paragraph>
                            ...
                            <>
                                {fields.map((field: any, index: number) => (
                                    <Row className='cvat-organization-invitation-field' key={field.key}>
                                        ...
                                        <Col span={10} offset={1}>
                                            ...
                                            >
                                                <Select>
                                                    <Select.Option value='worker'>{t('organization-page_top-bar_tsx.Worker', 'Worker')}</Select.Option>
                                                    <Select.Option value='supervisor'>{t('organization-page_top-bar_tsx.Supervisor', 'Supervisor')}</Select.Option>
                                                    <Select.Option value='maintainer'>{t('organization-page_top-bar_tsx.Maintainer', 'Maintainer')}</Select.Option>
                                                </Select>
                                            </Form.Item>
                                        </Col>
                                        <Col span={1} offset={1}>
                                ...
                                <Form.Item>
                                    <Button className='cvat-invite-more-org-members-button' icon={<PlusCircleOutlined />} onClick={() => add()}>
                                        {t('organization-page_top-bar_tsx.Iftheemailaddressisr', 'Invite more')}
                                    </Button>
                                </Form.Item>
                            </>
                        )}
