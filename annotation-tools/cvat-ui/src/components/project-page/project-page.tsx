...
export default function ProjectPageComponent(): JSX.Element {
        ...
        if (Number.isInteger(id)) {
            core.projects.get({ id })
                .then(([project]: Project[]) => {
                    ...
                    if (mounted.current) {
                        notification.error({
                            message: t('create-project-page_create-project-page_tsx.requestedProjectFailed'),
                            description: '项目为空',
    ...
    if (fechingProject) {
        return <LoadingSkeleton image={false} rows={5} times={2} title />
    }
    ...
    if (!projectInstance) {
        return (
            <Result
                ...
                status='404'
                title={t("create-project-page_create-project-page_tsx.wrongProjectMsg")}
                subTitle={t("create-project-page_create-project-page_tsx.wrongProjectTitle")}
            />
        );
    }
    ...
    const content = tasksCount ? (
        <div className='flex flex-col gap-2 justify-center'>
            ...
            <Pagination
                className='cvat-project-tasks-pagination !my-2'
                            ...
                            <Dropdown
                                ...
                                overlay={(
                                    <CvatDropdownMenuPaper>
                                        ...
                                        >
                                            {t('project-page_project-page_tsx.Createanewtask', 'Create a new task')}
                                        </Button>
                                        <Button
                                            type='primary'
                                        ...
                                        >
                                            {t('project-page_project-page_tsx.Createmultitasks', 'Create multi tasks')}
                                        </Button>
                                    </CvatDropdownMenuPaper>
                                )}
                            >
