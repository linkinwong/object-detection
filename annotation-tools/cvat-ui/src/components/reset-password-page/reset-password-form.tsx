...
function ResetPasswordFormComponent({ fetching, onSubmit }: Props): JSX.Element {
    ...
    return (
        <div className='cvat-password-reset-form-wrapper'>
            ...
            <Row>
                <Col>
                    <Title level={2}>{t('reset-password-page_reset-password-form_tsx.Forgotpassword', ' Forgot password? ')}</Title>
                </Col>
            </Row>
            <Row>
                <Col>
                    <Title level={2}>{t('reset-password-page_reset-password-form_tsx.Letscreateanewone', ' Let&apos;s create a new one ')}</Title>
                </Col>
            </Row>
            <Form
                form={form}
            ...
            >
                ...
                <Row>
                    <Col className='cvat-password-reset-tip'>
                        <Text>{t('reset-password-page_reset-password-form_tsx.Wewillsendlinktoyour', ' We will send link to your email ')}</Text>
                    </Col>
                </Row>
                <Form.Item>
                    <Button
                        ...
                        htmlType='submit'
                    >
                        {t('reset-password-page_reset-password-form_tsx.Send', 'Send')}
                    </Button>
                </Form.Item>
            </Form>
        </div>
