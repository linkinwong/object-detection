...
import {
    DownOutlined, FilterFilled, FilterOutlined, ClearOutlined,
            ...
            <div className='cvat-resource-page-filters'>
                {
                    predefinedFilters && onPredefinedVisibleChange ? (
                        ...
                        >
                            ...
                            >
                                {t('resource-sorting-filtering_filtering_tsx.Quickfilters', 'Quick filters')}
                        ...
                        <div className='cvat-resource-page-filters-builder'>
                            { Object.keys(recentFilters).length ? (
                                ...
                                >
                                    ...
                                    >
                                        {t('resource-sorting-filtering_filtering_tsx.Recent', 'Recent')}
                                        <DownOutlined />
                                    </Button>
                                </Dropdown>
                            ) : null}
                            ...
                            <Space className='cvat-resource-page-filters-space'>
                                ...
                                >
                                    {t('resource-sorting-filtering_filtering_tsx.Reset', 'Reset')}
                                </Button>
                                <Button
                                ...
                                >
                                    {t('resource-sorting-filtering_filtering_tsx.Apply', 'Apply')}
                                </Button>
                            </Space>
                        </div>
                    )}
