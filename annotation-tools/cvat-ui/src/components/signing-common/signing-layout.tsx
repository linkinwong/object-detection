                ...
                <Content>
                    <Row justify='center' align='middle' style={{ height: '100%' }}>
                        <Col {...titleSizes} className='cvat-signing-title'>
                            <Title>{t('signing-common_signing-layout_tsx.OpenData', 'Open Data')}</Title>
                            <Title>{t('signing-common_signing-layout_tsx.AnnotationPlatform', 'Annotation Platform')}</Title>
                        </Col>
                        {children}
                    </Row>
                </Content>
