...
export default function BugTrackerEditorComponent(props: Props): JSX.Element {
            ...
            <Row className='cvat-issue-tracker'>
                <Col>
                    <Text strong className='cvat-text-color'>
                        {t('task-page_bug-tracker-editor_tsx.IssueTracker', 'Issue Tracker')}
                    </Text>
                    ...
                    >
                        {t('task-page_bug-tracker-editor_tsx.Opentheissue', 'Open the issue')}
                    </Button>
                </Col>
            </Row>
        );
    ...
    return (
        <Row className='cvat-issue-tracker'>
            <Col>
                <Text strong className='cvat-text-color'>
                    {t('task-page_bug-tracker-editor_tsx.IssueTracker_1', 'Issue Tracker')}
                </Text>
                <Text
