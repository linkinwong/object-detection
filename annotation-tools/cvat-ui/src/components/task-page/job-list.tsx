    ...
    return (
        <>
            <div className='cvat-jobs-list-filters-wrapper'>
                <Row>
                    <Col>
                        <Text className='cvat-text-color cvat-jobs-header'> {t('task-page_job-list_tsx.Jobs', 'Jobs')} </Text>
                    </Col>
                    <CVATTooltip trigger='click' title={t('task-page_job-list_tsx.CopiedTitle')}>
                        <Button
                        ...
                        >
                            <CopyOutlined />
                            {t('task-page_job-list_tsx.Copy', 'Copy')}
                        </Button>
                    </CVATTooltip>
                </Row>
                <Row>
