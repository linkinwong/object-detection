    ...
    return (
        <Row className='cvat-webhooks-list-item' style={isRemoved ? { opacity: 0.5, pointerEvents: 'none' } : {}}>
            ...
            <Col span={6}>
                ...
                <Text type='secondary'>{`最近修改 ${updated}`}</Text>
            </Col>
            <Col span={6} offset={1}>
                <Paragraph ellipsis={{
                    tooltip: targetURL,
            ...
            <Col span={6} offset={1}>
                ...
                >
                    <Text type='secondary' className='cvat-webhook-info-text'>{t('webhooks-page_webhook-item_tsx.Events', 'Events:')}</Text>
                    {eventsList}
                </Paragraph>
            </Col>
            <Col span={3}>
                            ...
                            overlay={() => (
                                <Menu>
                                    <Menu.Item key='edit'>
                                        ...
                                        >
                                            {t('webhooks-page_webhook-item_tsx.Edit', 'Edit')}
                                        </a>
                                    </Menu.Item>
                                    <Menu.Item
                                        key='delete'
                                    ...
                                    >
                                        {t('webhooks-page_webhook-item_tsx.Delete', 'Delete')}
                                    </Menu.Item>
                                </Menu>
                            )}
                        >
                            <div className='cvat-webhooks-page-actions-button'>
                                <Text className='cvat-text-color'>{t('webhooks-page_webhook-item_tsx.Actions', 'Actions')}</Text>
