	...
	const { t } = useTranslation();
            <Row className='cvat-player-setting'>
                ...
                <Col className='cvat-workspace-settings-auto-save-interval'>
                    ...
                    />
                    <Text type='secondary'> t("header_settings-modal_workspace-settings_tsx.minutes", "minutes") nihaoya 'eqewqe'</Text>
                </Col>
            </Row>
            <Row className='cvat-player-setting'>
...
pattern = r'>(.*?)(%s)(.*?)<' % 'nihaoya'
new_code_content = re.sub(pattern, replace_func, code_content, re.S)
print(new_code_content)
