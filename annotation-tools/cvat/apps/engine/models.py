...
class Data(models.Model):
    ...
    sorting_method = models.CharField(max_length=15, choices=SortingMethod.choices(),
                                      default=SortingMethod.LEXICOGRAPHICAL)
...
class Audio(models.Model):
    data = models.ForeignKey(Data, on_delete=models.CASCADE, related_name="audio", null=True)
    path = models.CharField(max_length=1024, default='')
...
class Text(models.Model):
    data = models.ForeignKey(Data, on_delete=models.CASCADE, related_name="text", null=True)
    path = models.CharField(max_length=1024, default='')
    frame = models.PositiveIntegerField(default=0)
    width = models.PositiveIntegerField(default=0)
    height = models.PositiveIntegerField(default=0)
...
class Task(TimestampedModel):
    ...
    name = SafeCharField(max_length=256)
    type = models.CharField(max_length=32, choices=TaskType.choices(), default=TaskType.AUDIO)
...
class AIAudioMateAnnotation(models.Model):
    job = models.ForeignKey(Job, on_delete=models.CASCADE)
    start = models.FloatField(blank=False, null=True)
    end = models.FloatField(blank=False, null=True)
