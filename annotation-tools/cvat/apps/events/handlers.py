...
def organization_slug(instance):
    ...
    try:
        ...
        if org is not None:
            return org.slug
                # 如果没有 organization 属性，尝试调用 get_organization_slug 方法
        if hasattr(instance, "get_organization_slug"):
            return instance.get_organization_slug()
        # 如果 instance 既没有 organization 属性，也没有 get_organization_slug 方法
        return None
    except Exception:
        return None
