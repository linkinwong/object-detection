...
OCR_URL = os.getenv('OCR_URL' ,'http://172.16.160.237:23725')
ASR_URL = os.getenv('ASR_URL' ,'http://60.10.135.150:23727')
FACE_URL = os.getenv('FACE_URL' ,'http://172.16.160.237:23726')
OBJECT_URL = os.getenv('OBJECT_URL', 'http://172.16.160.237:23728')
SEGMENT_URL = os.getenv('SEGMENT_URL', 'http://172.16.160.237:23728')
VIDEO_TRACK_URL = os.getenv('VIDEO_TRACK_URL', 'http://60.10.135.150:23731')
AITOOLS_TIMEOUT = int(os.getenv('AITOOLS_TIMEOUT' ,30))
EXPORT_AUDIO_URL = os.getenv('EXPORT_AUDIO_URL', 'http://172.16.160.237:9591/export_annotations')
EXPORT_TEXT_URL = os.getenv('EXPORT_TEXT_URL', 'http://172.16.160.237:9592/export_annotations')
