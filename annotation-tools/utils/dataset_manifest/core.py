        ...
        for idx in range(self._stop):
            if idx in self.range_:
                ...
                try:
                    ...
                    # /home/shinemo/Projects/CVAT/cvat-develop-origin/cvat-develop/utils/dataset_manifest
                    # image = r'/home/shinemo/Projects/CVAT/cvat-develop-origin/cvat-develop/data/data/audio.png'
                    image = os.path.join(os.path.dirname(os.path.dirname(FILE_PATH)), 'data', 'data', 'audio.png')
                    print('image: ', image)
                    img = Image.open(image, mode='r')
